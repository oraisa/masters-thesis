...
\]
With \(H(\theta, p) = U(\theta) + \frac{p^2}{m}\),
\[
    P(\theta, p) \propto \exp(-U(\theta))\exp\left(\frac{p^2}{2m}\right)
\]
This means that the marginal distributions of \(\theta\) and \(p\) are 
independent, the marginal distribution of \(p\) is a Gaussian distribution 
with mean 0 and variance \(m\), and the marginal distribution of 
