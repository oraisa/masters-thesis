...
A generalised function can used as a density of a random variable, even the
...
proposal for given \((\theta, p)\). Such random functions are called
...
\]
which is true for random function reversibly by negating \(p\).
